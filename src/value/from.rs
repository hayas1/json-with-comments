...
impl<I, F> From<NumberValue<I, F>> for JsoncValue<I, F> {
    fn from(value: NumberValue<I, F>) -> Self {
...
//         JsoncValue::Number(NumberValue::Integer(value))
//     }
// }
// impl< I, F: num::Float> From<F> for JsoncValue< I, F> {
//     fn from(value: F) -> Self {
//         JsoncValue::Number(NumberValue::Float(value))
//     }
// }
